...
import com.yuanno.oniclawaddon.abilities.oni.RoarAbility;
...
public class ModAbilities {
    ...
    public static final AbilityCore[] ONI_ABILITIES = new AbilityCore[] {OniOverdriveAbility.INSTANCE, JumpAttackAbility.INSTANCE, ThunderBaguaAbility.INSTANCE, RoarAbility.INSTANCE};
